...
const Terms = () => (
  <PageShell
    ...
    description={`Terms of use for Modest (${SITE_NAME}) at bemoremodest.com. Purchases are processed through Shopify checkout. This page is a draft pending legal review.`}
    path="/terms"
    eyebrow="Legal"
  ...
  >
    ...
    <p className="text-cream/50 text-sm mb-10">
      Draft for legal review. The legal entity name, registered address, and governing-law jurisdiction are not specified in this project and are not invented here.
    </p>

    <section className="space-y-3 mb-8">
      <h2 className="font-display text-2xl text-cream tracking-wider">Site use</h2>
      <p className="text-cream/60 leading-relaxed">
        By using {SITE_URL.replace('https://', '')} you agree to these terms. The site is offered by {ENTITY_NAME} (stylized {SITE_NAME}) for browsing and purchasing products.
      </p>
    </section>
    ...
    <section className="space-y-3 mb-8">
      ...
      <p className="text-cream/60 leading-relaxed">
        Orders are placed through Shopify checkout. A contract of sale is formed according to Shopify’s checkout flow and the payment you authorize there. We may refuse or cancel an order we believe is fraudulent, erroneous, or cannot be fulfilled.
      </p>
    </section>
    ...
    <section className="space-y-3 mb-8">
      ...
      <p className="text-cream/60 leading-relaxed">
        {SITE_NAME} branding, designs, text, and images on this site are owned by Modest or used with permission. You may not copy or exploit them without permission, except as allowed by law (for example fair use).
      </p>
    </section>
    ...
    <section className="space-y-3 mb-8">
      ...
      <p className="text-cream/60 leading-relaxed">
        If you send us a message, application, or other content, you grant Modest a non-exclusive right to use it to respond and operate the business. Do not send confidential designs you are not prepared to share.
      </p>
    </section>
    ...
    <section className="space-y-3 mb-8">
      ...
      <p className="text-cream/60 leading-relaxed">
        To the fullest extent permitted by law, Modest is not liable for indirect, incidental, or consequential damages arising from use of the site. Some jurisdictions do not allow certain limitations; in those places our liability is limited to the maximum allowed.
      </p>
    </section>
    ...
    <section className="space-y-3 mb-8">
      ...
      <p className="text-cream/60 leading-relaxed">
        Owner / legal confirmation required. These terms do not name a governing jurisdiction, arbitration clause, or class-action waiver because none is recorded in this project.
      </p>
    </section>
    ...
    <section className="space-y-3">
      ...
      <p className="text-cream/60 leading-relaxed">
        {PRIVACY_CONTACT_EMAIL}. Shipping and returns processes are described on{' '}
